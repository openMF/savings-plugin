...
public class KycStatusDerivationService {
    ...
    /**
     * Derives the KYC status from the boolean flags and the decision status
     * received from the external KYC provider.
     *
     * Rules:
     *   - All TRUE + decision "Approved"   → "Approved"
     *   - Decision "Declined"              → "Rejected"
     *   - Decision "Approved" but missing features → "In Review"
     *   - No decision or null              → "In Review"
     */
    public String deriveStatus(final boolean faceMatches,
