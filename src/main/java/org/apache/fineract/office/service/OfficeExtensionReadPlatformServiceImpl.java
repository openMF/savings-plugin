...
public class OfficeExtensionReadPlatformServiceImpl implements OfficeExtensionReadPlatformService {
    ...
    private static final class OfficeGeolocationRowMapper implements RowMapper<OfficeGeolocationData> {
        @Override
    ...
    // Note: Kept strictly for field config retro-compatibility from original snippet, though it operates on entirely different tables.
    private static final class OfficeAddrConfigMapper implements RowMapper<OfficeAddressData> {
        ...
        @Override
        public OfficeAddressData mapRow(final ResultSet rs, final int rowNum) throws SQLException {
            // Usually maps to FieldConfigurationData. Returning barebones instance to prevent breaking the signature.
            return OfficeAddressData.instance(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        }
    }
}