              ...
              array =
                  @ArraySchema(
                      schema =
                          @Schema(
                              implementation =
                                  SavingsOfficesApiResourceSwagger.GetOfficesResponse.class))))
      ...
      content =
          @Content(
              schema =
                  @Schema(
                      implementation =
                          SavingsOfficesApiResourceSwagger.GetOfficesTemplateResponse.class)))
  ...
  @ApiResponse(
      ...
      content =
          @Content(
              schema =
                  @Schema(
                      implementation = SavingsOfficesApiResourceSwagger.GetOfficesResponse.class)))
