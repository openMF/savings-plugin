...
@Tag(
    ...
    description =
        "API for accessing and managing exchange rates from the Central Bank of Costa Rica (BCCR)")
...
public class BccrExchangeRateApiResource {
  ...
  @Operation(
      ...
      description = "Manually creates a new BCCR exchange rate record.")
  public String createRate(final String apiRequestBodyAsJson) {
    ...
    BccrExchangeRateRequest req =
        gson.fromJson(apiRequestBodyAsJson, BccrExchangeRateRequest.class);
  ...
  @Operation(
      ...
      description = "Updates an existing BCCR exchange rate record.")
  public String updateRate(@PathParam("id") Long id, final String apiRequestBodyAsJson) {
    ...
    BccrExchangeRate rate =
        exchangeRateService
            .getRateById(id)
            .orElseThrow(
                () -> new IllegalArgumentException("Exchange rate not found with id: " + id));
  ...
  public String deleteRate(@PathParam("id") Long id) {
    ...
    return gson.toJson(
        Map.of("status", "success", "message", "Exchange rate deleted successfully"));
  }
  ...
  @Operation(
      ...
      description =
          "Triggers a manual fetch of today's exchange rate from BCCR. Requires create exchange-rate permission.")
